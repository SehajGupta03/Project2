...
private:
    ...
    /// machine 1
    std::shared_ptr<MachineDrawable> mMachineOne = nullptr;

    /// machine 2
    std::shared_ptr<MachineDrawable> mMachineTwo = nullptr;
