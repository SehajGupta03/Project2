...
private:
    ...
    void OnMachine1(wxCommandEvent& event);
    void OnMachine2(wxCommandEvent& event);
    void OnMachine1Time(wxCommandEvent& event);
    void OnMachine2Time(wxCommandEvent& event);
